    ...
    return (
        <>
            <div
                ...
                <p></p>
                <p className="text-white leading-5 my-2 text-xs md:text-lg text-center relative z-10">
                    La première plateforme Africaine dédiés aux jobs 100% télétravail.

                </p>
                <p className="text-white text-xs md:text-lg text-center "> Inscris toi à la
